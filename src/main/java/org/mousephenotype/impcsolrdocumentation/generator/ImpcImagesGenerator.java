...
public class ImpcImagesGenerator {
    ...
    public static ImpcImages generateExampleImpcImagesResponse() {
        ...
        impcImages.setTopLevelAnatomyTermSynonym(List.of("TL Anatomy Term 1", "TL Anatomy Term 2"));
        ...
        impcImages.setSelectedTopLevelAnatomyTermSynonym(List.of("Selected TL Anatomy Term 1", "Selected TL Anatomy Term 2"));
        ...
        impcImages.setIntermediateAnatomyTermSynonym(List.of("Intermediate Anatomy Term 1", "Intermediate Anatomy Term 2"));
        ...
        impcImages.setParentAnatomyTermSynonym(List.of("Parent Anatomy Term 1", "Parent Anatomy Term 2"));
        ...
        impcImages.setChildAnatomyTermSynonym(List.of("Child Anatomy Term 1", "Child Anatomy Term 2"));
